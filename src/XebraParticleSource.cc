...
XebraParticleSource::XebraParticleSource()
{
	...
	m_pMessenger = new XebraParticleSourceMessenger(this);
...
void
XebraParticleSource::SetEnergyFile(G4String hEnergyFile)
{
...
G4bool
XebraParticleSource::ReadEnergySpectrum()
{
...
void
XebraParticleSource::SetParticleDefinition(G4ParticleDefinition * aParticleDefinition)
{
...
void
XebraParticleSource::ConfineSourceToVolume(G4String hVolumeList)
{
...
void
XebraParticleSource::GeneratePointSource()
{
...
void
XebraParticleSource::GeneratePointsInVolume()
{
...
void
XebraParticleSource::GeneratePointsInSurface()
{
  G4ThreeVector RandPos;
  G4double x = 0., y = 0., z = 0.;
...
G4bool
XebraParticleSource::IsSourceConfined()
{
...
void
XebraParticleSource::GenerateIsotropicFlux()
{
	G4double rndm, rndm2;
	G4double px, py, pz;
...
void
XebraParticleSource::GenerateMonoEnergetic()
{
	m_dParticleEnergy = m_dMonoEnergy;
}

void
XebraParticleSource::GenerateEnergyFromSpectrum()
{
	m_dParticleEnergy = m_hEnergySpectrum.GetRandom()*MeV;
}

void
XebraParticleSource::GeneratePrimaryVertex(G4Event * evt)
{
...
void
XebraParticleSource::GeneratePrimaryVertexFromTrack(G4Track *pTrack, G4Event *pEvent)
{
